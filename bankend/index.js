...
//dat base connection  with mongo db 

mongoose.connect("mongodb+srv://beststackdev:shivam123@cluster0.bzxwf3p.mongodb.net/e-commerce")
...
app.post('/addproduct',async (req,res)=>{
    ...
    let id;   //id ke liye aoutomatic genarte of any product
...
//creating middleware products to fetch user
...
// creating end point remove product from carTdata
